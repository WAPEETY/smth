...
<div class="relative mt-12 w-full max-w-lg sm:mt-10">
    ...
    <div
        ...
        <div class="flex flex-col p-6">
            <h3 class="text-xl font-semibold leading-6 tracking-tighter">Welcome back!</h3>
            <p class="mt-1.5 text-sm font-medium text-white/50">To continue, enter your secret code.
            </p>
        </div>
        <div class="p-6 pt-0">
                    ...
                    <div>
                        <div
                            ...
                            <div class="flex justify-between">
                                <label class="text-xs font-medium text-muted-foreground group-focus-within:text-white text-gray-400">Secret</label>
                            </div>
